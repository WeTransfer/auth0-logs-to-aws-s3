...
module.exports = () => {
  ...
  <head>
    ...
    <% if (assets.version) { %><link rel="stylesheet" type="text/css" href="//cloud-cdn.safe.com/auth0-extensions/auth0-logs-to-aws-s3/assets/auth0-logs-to-aws-s3.ui.<%= assets.version %>.css" /><% } %>
  ...
  <body>
    ...
    <% if (assets.version) { %>
    <script type="text/javascript" src="//cloud-cdn.safe.com/auth0-extensions/auth0-logs-to-aws-s3/assets/auth0-logs-to-aws-s3.ui.vendors.<%= assets.version %>.js"></script>
    <script type="text/javascript" src="//cloud-cdn.safe.com/auth0-extensions/auth0-logs-to-aws-s3/assets/auth0-logs-to-aws-s3.ui.<%= assets.version %>.js"></script>
    <% } %>
  </body>
  </html>
  `;
